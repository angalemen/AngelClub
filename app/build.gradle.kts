...
android {
    namespace = "com.example.clubesvcannabicos"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.clubesvcannabicos"
        minSdk = 19
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    configurations.all {
        resolutionStrategy.dependencySubstitution {
            substitute(module("org.hamcrest:hamcrest:2.2")).using(module("junit:junit:4.13.2"))
        }
    }
}